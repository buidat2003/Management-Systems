        ...
        http
                ...
                .authorizeRequests(authz -> authz
                        ...
                        .requestMatchers("/login", "/home", "/forgot", "/recovery",
                                ...
                                "/download/cv/*","/jobcandidate", "/static/**", "/offers/infoCreate/{id}","/api/users/update-all-calendar-links","/api/users/update-calendar-links-for-interviewers", "/users/{id}/activate", "/users/{id}/deactivate")
                        .permitAll()
